...
function toggleLaunchArea(loading){
    if(loading){
        ...
        // Desativar os bot�es dentro de launch_content
        ...
        // Ativar os bot�es dentro de launch_content
        const launchButton = document.querySelector('#launch_button');
        const serverSelectionButton = document.querySelector('#server_selection_button');
...
async function fetchSkinAndConvertToBase64(username) {
    try {
      const skinURL = `https://armaz-mc.com/api/skin-api/skins/${username}`;
...
const refreshServerStatus = async (fade = false) => {
    ...
    try {
        // Obt�m o status do servidor
        const servStat = await getServerStatus(47, serv.hostname, serv.port)
        console.log(servStat)

        // Atualiza informa��es de players online
    ...
    // Atualiza o conte�do de _status_wrapper
